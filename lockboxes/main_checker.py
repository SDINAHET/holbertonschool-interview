...
test_cases = [
    ...
    ([[10, 3, 8, 9, 6, 5, 8, 1],
      ...
      [4, 2, 5, 1, 1, 6, 4, 5, 6],
      [9, 5, 8, 8],
      [6, 2, 8, 6]], True, "Correct output - case: [[10, 3, 8, 9, 6, 5, 8, 1], [8, 5, 3, 7, 1, 8, 6], [5, 1, 9, 1], [], [6, 6, 9, 4, 3, 2, 3, 8, 5], [9, 4], [4, 2, 5, 1, 1, 6, 4, 5, 6], [9, 5, 8, 8], [6, 2, 8, 6]]"),
    ([[7, 5],
      [1, 10, 7],
      [9, 6, 10],
      [7, 9],
      ...
      [7, 9, 10, 10, 8, 9, 2, 5],
      [7, 2, 2, 4, 4, 2, 4, 8, 7],
      [4, 2, 9, 6, 6, 5, 5]], False, "Correct output - case: [[7, 5], [1, 10, 7], [9, 6, 10], [7, 9], [2], [7, 3], [7, 9, 10, 10, 8, 9, 2, 5], [7, 2, 2, 4, 4, 2, 4, 8, 7], [4, 2, 9, 6, 6, 5, 5]]")]
...
# Test PEP8 avec pycodestyle
print("\nRunning PEP8 check...")
pep8_check = subprocess.run(["pycodestyle", source_path], capture_output=True, text=True)

if pep8_check.returncode == 0:
    print("PEP8 validation ✅")
else:
    print("PEP8 errors found ❌")
    print(pep8_check.stdout)
    sys.exit(1)
